...
class ContratoController extends Controller
{
    ...
    private function setBtns(Contrato $contratos){
        ...
        $dadosVisualizar = "data-empresa_contratada_nome='$contratos->empresa_contratada_nome' data-empresa_contratada_cnpj='$contratos->empresa_contratada_cnpj' data-numero_contrato='$contratos->numero_contrato' data-data_inicio_contrato='$teste' data-data_vencimento_contrato='$teste2' data-valor_contratado='$contratos->valor_contratado' data-tipo='$contratos->tipo'";
