...
class ViagemController extends Controller
{
    ...
    public function store(Request $request) { // cadastro de viagem
        ...
        $rules = array(
            ...
            'nome_responsavel' => 'required|alpha|min:3|max:45',
            'telefone_responsavel' => 'required',
            'local_saida' => 'required|alpha|min:3|max:45',
            'setor_autoriza_viagem' => 'required',
            'numero_passageiros' => 'required|numeric',
            'tipo_solicitacao' => 'required|aplha|min:3|max:45',
            'natureza_servico' => 'required|aplha|min:3|max:45',
