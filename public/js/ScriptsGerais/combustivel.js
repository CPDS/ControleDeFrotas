$(document).ready(function($) {
    ...
    var tabela = $('#tabela_combustivel').DataTable({
            processing: true,
            serverSide: true,
            deferRender: true,
    ...
    $(document).on('click', '.btnEditar', function() {
        ...
        $('.modal-title').text('Editar Cadastro de Combustível');
...
*/
  ...
  //  });
    ...
    //Excluir
    $(document).on('click', '.btnDeletar', function() {
        $('.modal-title').text('Excluir Combustível');
        $('.id_del').val($(this).data('id'));
        jQuery('#excluir-modal').modal('show'); //Abrir o modal
    });

    //Adicionar
    $(document).on('click', '.btnAdicionarCombustivels', function() {
        $('.modal-footer .btn-action').removeClass('edit');
        $('.modal-footer .btn-action').addClass('add');

        $('.modal-title').text('Novo Cadastro de Combustível');
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if ((data.errors)) {
                    ...
                    $('#tabela_combustivel').DataTable().draw(false);
    ...
    $('.modal-footer').on('click', '.del', function() {
        ...
        $.ajax({
            ...
            success: function(data) {
                $('#tabela_combustivel').DataTable().row('#item-' + data.id).remove().draw(); //remove a linha e ordena
