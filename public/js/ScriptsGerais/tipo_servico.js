$(document).ready(function($) {
    ...
    var tabela = $('#tabela_tiposervico').DataTable({
            processing: true,
            serverSide: true,
            deferRender: true,
...
*/
  ...
  //  });
    ...
    //Adicionar
    $(document).on('click', '.btnAdicionarTipoServico', function() {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if ((data.errors)) {
                    ...
                    $('#tabela_tiposervico').DataTable().draw(false);
    ...
    $('.modal-footer').on('click', '.del', function() {
        ...
        $.ajax({
            ...
            success: function(data) {
                $('#tabela_tiposervico').DataTable().row('#item-' + data.id).remove().draw(); //remove a linha e ordena
